...
for (var i = 0; i < data.length; i++) {
    if(document.querySelectorAll(".heading").value=="PRODUCTS"){
...
for(var i=0;i<data.length;i++){
    if(document.querySelectorAll(".heading").innerHTML=="PANTS"){
        if(i>11 && i<18){
...
for(var i=0;i<data.length;i++){
    if(document.querySelectorAll(".heading").value=="PANTS"){
        if( i>23 && i<30){
...
if(document.querySelectorAll(".heading").innerHTML==="WOMEN"){
for(var i=0;i<data.length;i++){
    if(data[i].id>=1025){   
